...
<form action="<?php echo "$basePath/default/update-record-submit?domain=$domain&amp;id=$id" ?>" method="post" id="updateRecordForm" class="col-12 offset-md-3 col-md-6">
...
<script>
	...
	<?php include_once(__DIR__ . '/updateRecordForm.js'); ?>
</script>
